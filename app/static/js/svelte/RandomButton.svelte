...
<style>
    ...
    .animate-coin-flip {
        animation: coin-flip 0.4s linear infinite;
    }

    .animate-dice-roll {
        animation: dice-roll 0.3s linear infinite;
    }

    .animate-d20-roll {
        animation: d20-roll 0.5s linear infinite;
    }
    ...
    .animate-number-spin {
        animation: number-spin 0.15s ease-in-out infinite;
    }
</style>
